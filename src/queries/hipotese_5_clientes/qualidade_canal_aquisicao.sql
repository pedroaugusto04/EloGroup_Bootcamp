-- ==============================================================================
-- Query: Qualidade do Canal de Aquisição vs Retenção de Clientes (Hipótese 5)
-- Finalidade: Avaliar LTV acumulado, CAC, LTV/CAC e concentração de alto valor vs churn.
