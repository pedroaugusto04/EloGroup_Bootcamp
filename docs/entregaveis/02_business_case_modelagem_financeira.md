...
3. **Rastreio + Atendimento N1:** reduz consultas operacionais com comunicação proativa e autoatendimento.

## Impacto estimado — cenário-base

| Frente | Impacto | Premissa principal | KPI de acompanhamento |
| --- | ---: | --- | --- |
...
| CX e N1 | **R$ 55,7 mil/ano de economia estimada** | Captura de 80% do custo de rastreio e 50% do custo de dúvidas técnicas. | Tickets de rastreio, FCR e CSAT. |

## Retorno econômico

A liquidação gera entrada de caixa. O ROI considera a margem recuperada e a economia operacional.

| Indicador | Cenário-base |
| --- | ---: |
| Margem recuperada + economia anual | **R$ 1,86M** |
...
**Decisão solicitada:** aprovar o ciclo de 90 dias, com revisão dos KPIs nos dias 30, 60 e 90 antes de ampliar o escopo.
