...
Base de Clientes: Segmentação RFM, LTV, frequência de compras e perfil demográfico.
"""
...
def show_clientes(repo: DuckDBRepository):
    ...
    st.markdown('<div class="page-subtitle">Comportamento de compra, fidelidade, valor do ciclo de vida (LTV) e distribuição regional.</div>', unsafe_allow_html=True)
    ...
    st.subheader("Tabela de Segmentos RFM")
