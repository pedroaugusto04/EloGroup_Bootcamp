...
export const ScopeBadge: React.FC<ScopeBadgeProps> = ({
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 py-1.5 px-2.5 sm:py-2 sm:px-3 mb-4 sm:mb-5 rounded-md bg-[#121215] border border-[#27272a] text-[11px] sm:text-xs text-[#a1a1aa] leading-relaxed">
      <div className="flex items-center gap-1 sm:gap-1.5 font-mono text-[#38bdf8]">
